...
std::vector<Card *> hand;
  ...
  std::cout << "Debut des tests de la hauteur." << std::endl;

  assert(hauteur(hand) == Card::SIX);
  assert(hauteur(hand2) ==  Card::CINQ);
  assert(hauteur(hand3) ==  Card::SIX);
  assert(hauteur(hand4) == Card::ROI);
  assert(hauteur(hand5) ==  Card::ROI);
